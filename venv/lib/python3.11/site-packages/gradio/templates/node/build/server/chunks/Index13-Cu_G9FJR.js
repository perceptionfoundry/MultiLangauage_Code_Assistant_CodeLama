...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper } from './2-DpgRF3pD.js';
...
const lang_map = {
  python: () => import('./index29-2fb8-fAq.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index30-DvVpk3w2.js'),
      import('./frontmatter-DBt3q8qb.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index34-DwBqVYaW.js').then((m) => m.json()),
  html: () => import('./index31-DMFoOY9i.js').then((m) => m.html()),
  css: () => import('./index32-4GqW8oOp.js').then((m) => m.css()),
  javascript: () => import('./index33-CKigAkVW.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index33-CKigAkVW.js').then(
...
//# sourceMappingURL=Index13-Cu_G9FJR.js.map
